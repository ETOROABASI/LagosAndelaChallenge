...
public class UserDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        avatarImageView = (ImageView) findViewById(R.id.user_detail_avatar);
        userNameTextView = (TextView) findViewById(R.id.user_detail_name);
        userUrlTextView = (TextView) findViewById(R.id.user_detail_url);
    ...
    private void shareProfile() {
        ...
        ShareUtilities.shareCustom(message, this);
